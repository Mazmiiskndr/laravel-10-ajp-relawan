...
interface VolunteerRepository extends Repository
{
    /**
     ...
     */
    public function search($searchQuery, $columns, $relations);
     ...
     * @return mixed|null
     */
    public function createOrUpdate(array $attributes, $id);
